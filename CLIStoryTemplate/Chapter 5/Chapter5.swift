...
func chapterFive() {
    ...
    func tamerasStory()-> String {
        return "excelled in app development skills greatly grew. She not only mastered new code to add to her previous knowledge of Python and C++, but she went on to create a new language of code. She calls this code language TAM, which has been taught interchangeably with Swift. Her name is a household name in the field of technology, innovation, and app development."
    }
    ...
    func shanteStory()-> String {
        return "excelled in mastering code and went on to use the code to become a top freelance app developer, making applications for numerous fields including healthcare field that helped doctors and patients connect better. In addition, she travels the world learning new techniques and teaching others the coding and UI skills that she knows."
    }
...
///-----------------------------------------UNCOMMENT THIS LATER But Will Have to Uncode What's Above TOO-----
...
//---------------make a way to print two years later letter by letter
// fix what the output is to make more sense...
